...
use App\Http\Controllers\Api\ReferralController;
    ...
    Route::group(['middleware' => ['auth:sanctum']], function (): void {
        ...
        // Referral/Loyalty Routes (authenticated user)
        Route::post('referral/track-share', [ReferralController::class, 'trackShare']);
        Route::get('referral/balances', [ReferralController::class, 'getBalances']);
