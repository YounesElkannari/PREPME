...
class DashboardController extends Controller
{
    ...
    protected function clientStats()
    {
        ...
        return response()->json([
            ...
            // Current loyalty balances are the source of truth. The legacy
            // total_points_earned field is intentionally not used here.
            'order_points_balance' => $user->order_points_balance ?? 0,
            'share_points_balance' => $user->share_points_balance ?? 0,
            'free_meal_credits' => $user->free_meal_credits ?? 0,
