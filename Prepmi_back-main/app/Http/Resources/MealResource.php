...
class MealResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'image_url' => $this->image_path ? Storage::disk('public_uploads')->url($this->image_path) : null,
            'gallery_images' => $this->gallery_images,
            'gallery_urls' => $this->gallery_images ? array_map(fn($path) => Storage::disk('public_uploads')->url($path), $this->gallery_images) : [],
            'price' => $this->price,
